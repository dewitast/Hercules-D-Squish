...
\index{Orca@{Orca}!Orca@{Orca}}
\index{Orca@{Orca}!Orca@{Orca}}
\subsubsection[{\texorpdfstring{Orca(float w, float f, bool t)}{Orca(float w, float f, bool t)}}]{\setlength{\rightskip}{0pt plus 5cm}Orca\+::\+Orca (
\begin{DoxyParamCaption}
\item[{float}]{w, }
\item[{float}]{f, }
\item[{bool}]{t}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [inline]}}\hypertarget{classOrca_aed38e6130ea0084cc65031262bbdf39a}{}\label{classOrca_aed38e6130ea0084cc65031262bbdf39a}


Constructor dengan parameter. Menciptakan objek \hyperlink{classOrca}{Orca} dengan berat w, jumlah makanan f, dan status jinak t. 


\begin{DoxyParams}{Parameters}
{\em w} & Berat \hyperlink{classOrca}{Orca}. \\
\hline
{\em f} & Jumlah makanan \hyperlink{classOrca}{Orca}. \\
\hline
{\em t} & Status jinak \hyperlink{classOrca}{Orca}. \\
\hline
\end{DoxyParams}
...
\item 
\hyperlink{orca_8h}{orca.\+h}\end{DoxyCompactItemize}

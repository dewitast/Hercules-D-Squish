...
\index{Walrus@{Walrus}!Walrus@{Walrus}}
\index{Walrus@{Walrus}!Walrus@{Walrus}}
\subsubsection[{\texorpdfstring{Walrus(float w, float f, bool t)}{Walrus(float w, float f, bool t)}}]{\setlength{\rightskip}{0pt plus 5cm}Walrus\+::\+Walrus (
\begin{DoxyParamCaption}
\item[{float}]{w, }
\item[{float}]{f, }
\item[{bool}]{t}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [inline]}}\hypertarget{classWalrus_ad275ac9ac07871be362da7a4e180e68d}{}\label{classWalrus_ad275ac9ac07871be362da7a4e180e68d}


Constructor dengan parameter. Menciptakan objek \hyperlink{classWalrus}{Walrus} dengan berat w, jumlah makanan f, dan status jinak t. 


\begin{DoxyParams}{Parameters}
{\em w} & Berat \hyperlink{classWalrus}{Walrus}. \\
\hline
{\em f} & Jumlah makanan \hyperlink{classWalrus}{Walrus}. \\
\hline
{\em t} & Status jinak \hyperlink{classWalrus}{Walrus}. \\
\hline
\end{DoxyParams}
...
\item 
\hyperlink{walrus_8h}{walrus.\+h}\end{DoxyCompactItemize}

...
\index{Jalak@{Jalak}!Jalak@{Jalak}}
\index{Jalak@{Jalak}!Jalak@{Jalak}}
\subsubsection[{\texorpdfstring{Jalak(float w, float f, bool t)}{Jalak(float w, float f, bool t)}}]{\setlength{\rightskip}{0pt plus 5cm}Jalak\+::\+Jalak (
\begin{DoxyParamCaption}
\item[{float}]{w, }
\item[{float}]{f, }
\item[{bool}]{t}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [inline]}}\hypertarget{classJalak_a12f97db5ae28b059a948c7f52f5eb002}{}\label{classJalak_a12f97db5ae28b059a948c7f52f5eb002}


Constructor dengan parameter. Menciptakan objek \hyperlink{classJalak}{Jalak} dengan berat w, jumlah makanan f, dan status jinak t. 


\begin{DoxyParams}{Parameters}
{\em w} & Berat \hyperlink{classJalak}{Jalak}. \\
\hline
{\em f} & Jumlah makanan \hyperlink{classJalak}{Jalak}. \\
\hline
{\em t} & Status jinak \hyperlink{classJalak}{Jalak}. \\
\hline
\end{DoxyParams}
...
\item 
\hyperlink{jalak_8h}{jalak.\+h}\end{DoxyCompactItemize}

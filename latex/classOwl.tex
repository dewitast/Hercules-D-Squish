...
\index{Owl@{Owl}!Owl@{Owl}}
\index{Owl@{Owl}!Owl@{Owl}}
\subsubsection[{\texorpdfstring{Owl(float w, float f, bool t)}{Owl(float w, float f, bool t)}}]{\setlength{\rightskip}{0pt plus 5cm}Owl\+::\+Owl (
\begin{DoxyParamCaption}
\item[{float}]{w, }
\item[{float}]{f, }
\item[{bool}]{t}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [inline]}}\hypertarget{classOwl_abdec4b1b8d1f146b55175bae78888a1d}{}\label{classOwl_abdec4b1b8d1f146b55175bae78888a1d}


Constructor dengan parameter. Menciptakan objek \hyperlink{classOwl}{Owl} dengan berat w, jumlah makanan f, dan status jinak t. 


\begin{DoxyParams}{Parameters}
{\em w} & Berat \hyperlink{classOwl}{Owl}. \\
\hline
{\em f} & Jumlah makanan \hyperlink{classOwl}{Owl}. \\
\hline
{\em t} & Status jinak \hyperlink{classOwl}{Owl}. \\
\hline
\end{DoxyParams}
...
\item 
\hyperlink{owl_8h}{owl.\+h}\end{DoxyCompactItemize}
